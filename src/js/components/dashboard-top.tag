<dashboard-top>
    ...
    <div id="mostread">
        <h3>{ opts.data.top[0].title }</h3><span class="rank">1</span>
        ...
        <h3>{ opts.data.top[1].title }</h3><span class="rank">2</span>
        ...
        <h3>{ opts.data.top[2].title }</h3><span class="rank">3</span>
        ...
        <h3>{ opts.data.top[3].title }</h3><span class="rank">4</span>
        ...
        <h3>{ opts.data.top[4].title }</h3><span class="rank">5</span>
